...
public class test {
	...
	public static  void test() throws IOException {
        ...
        FileChannel fileChannel = FileChannel.open(Paths.get("com/stefan/proxyLearning/jdkProxy/RealProxy.class"), StandardOpenOption.CREATE, StandardOpenOption.WRITE);
